use crate::{GraphicsAdapter, GraphicsError, GraphicsExtension, Result};
...
impl<'instance> GraphicsAdapter<'instance> {
    ...
    /// support them
    pub fn enumerate_all_extensions(&self) -> Result<Vec<GraphicsExtension>> {
        ...
        .map_err(|vk| GraphicsError::new_vk("unable to get device extension count", vk))?;
        ...
        .map_err(|vk| GraphicsError::new_vk("unable to get device extensions", vk))?;
