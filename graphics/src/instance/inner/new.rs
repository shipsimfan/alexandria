use crate::{
    GraphicsError, GraphicsInstanceExtension, GraphicsVersion, Result,
...
impl GraphicsInstanceInner {
    ...
    pub(in crate::instance) fn new(
        ...
        application: Option<(&str, GraphicsVersion)>,
        engine: Option<(&str, GraphicsVersion)>,
        ...
        let functions = GraphicsInstanceFunctions::load(handle, extensions)?;
