...
use vulkan::{
    ...
    VK_CMD_BIND_DESCRIPTOR_SETS, VK_CMD_BIND_INDEX_BUFFER, VK_CMD_BIND_PIPELINE,
    VK_CMD_BIND_VERTEX_BUFFERS, VK_CMD_COPY_BUFFER, VK_CMD_DRAW, VK_CMD_DRAW_INDEXED,
    VK_CMD_END_RENDERING, VK_CMD_PIPELINE_BARRIER2, VK_CMD_PUSH_CONSTANTS, VK_CMD_SET_SCISSOR,
    VK_CMD_SET_VIEWPORT, VK_END_COMMAND_BUFFER, VK_FREE_COMMAND_BUFFERS, VkDevice,
};
...
impl VulkanCommandBufferFunctions {
    ...
    pub fn load(
        ...
        Ok(VulkanCommandBufferFunctions {
            ...
            cmd_bind_descriptor_sets: load_device_function!(
                instance,
                device,
