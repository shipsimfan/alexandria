...
impl VulkanPipelineRasterizerStateCreateInfo {
    ...
    /// Set the depth bias clamp for the rasterizer state create info
    pub fn set_depth_bias_clamp(mut self, depth_bias_clamp: f32) -> Self {
        self.inner.depth_bias_clamp = depth_bias_clamp;
        self
    }

    /// Set the depth bias slope factor for the rasterizer state create info
    ...
    /// Set the line width for the rasterizer state create info
