...
pub use vulkan::{
    ...
    VkBlendOp as VulkanBlendOp, VkColorComponentFlag as VulkanColorComponentFlag,
    ...
    VkPhysicalDeviceType as VulkanAdapterKind,
    ...
    VkResolveModeFlags as VulkanResolveModeFlags, VkShaderStageFlag as VulkanShaderStageFlag,
