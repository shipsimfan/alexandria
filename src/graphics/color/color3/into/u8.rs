...
impl<Space: ColorSpace<u8> + ColorSpace<f32>> Color3<f32, Space> {
    ...
    pub const fn into_u8(self) -> Color3<u8, Space> {
        self.into_u8_round()
    }

    /// Convert this [`Color3`] from [`f32`] to [`u8`] rounding down to the nearest integer
    pub const fn into_u8_floor(self) -> Color3<u8, Space> {
    ...
    /// Convert this [`Color3`] from [`f32`] to [`u8`] rounding to the nearest integer
    pub const fn into_u8_round(self) -> Color3<u8, Space> {
    ...
    pub const fn into_u8_ceil(self) -> Color3<u8, Space> {
