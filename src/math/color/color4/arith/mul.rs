...
const impl<Space: ColorSpace<u8>> Mul<Color4<u8, Space>> for u8 {
...
const impl<Space: ColorSpace<u16>> Mul<Color4<u16, Space>> for u16 {
...
const impl<Space: ColorSpace<u32>> Mul<Color4<u32, Space>> for u32 {
...
const impl<Space: ColorSpace<u64>> Mul<Color4<u64, Space>> for u64 {
...
const impl<Space: ColorSpace<u128>> Mul<Color4<u128, Space>> for u128 {
...
const impl<Space: ColorSpace<usize>> Mul<Color4<usize, Space>> for usize {
...
const impl<Space: ColorSpace<i8>> Mul<Color4<i8, Space>> for i8 {
...
const impl<Space: ColorSpace<i16>> Mul<Color4<i16, Space>> for i16 {
...
const impl<Space: ColorSpace<i32>> Mul<Color4<i32, Space>> for i32 {
...
const impl<Space: ColorSpace<i64>> Mul<Color4<i64, Space>> for i64 {
...
const impl<Space: ColorSpace<i128>> Mul<Color4<i128, Space>> for i128 {
...
const impl<Space: ColorSpace<isize>> Mul<Color4<isize, Space>> for isize {
...
const impl<Space: ColorSpace<f32>> Mul<Color4<f32, Space>> for f32 {
...
const impl<Space: ColorSpace<f64>> Mul<Color4<f64, Space>> for f64 {
