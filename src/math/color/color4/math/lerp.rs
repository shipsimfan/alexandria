...
impl<T> Color4<T, Linear> {
    ...
    pub const fn lerp(self, b: Color4<T, Linear>, t: f32) -> Color4<T, Linear>
    where
...
mod tests {
    ...
    lerp_tests![
        ...
        lerp_u8_weighted_80pct_multiples_of_5: (10, 90, 30, 70), (210, 10, 130, 30), 0.8 -> (170, 25, 110, 38),
