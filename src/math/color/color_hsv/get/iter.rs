...
impl<T, Space: ColorSpace<T>> IntoIterator for ColorHsv<T, Space> {
    type Item = T;
...
impl<'a, T, Space: ColorSpace<T>> IntoIterator for &'a ColorHsv<T, Space> {
    type Item = &'a T;
...
impl<'a, T, Space: ColorSpace<T>> IntoIterator for &'a mut ColorHsv<T, Space> {
    type Item = &'a mut T;
