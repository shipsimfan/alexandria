...
impl<T, Space: ColorSpace<T>> IntoIterator for ColorHsva<T, Space> {
    type Item = T;
...
impl<'a, T, Space: ColorSpace<T>> IntoIterator for &'a ColorHsva<T, Space> {
    type Item = &'a T;
...
impl<'a, T, Space: ColorSpace<T>> IntoIterator for &'a mut ColorHsva<T, Space> {
    type Item = &'a mut T;
