...
const impl<T: [const] Sub<Output = T> + [const] Clone + [const] Destruct> Sub<T> for Matrix4x4<T> {
    type Output = Self;
...
const impl<T: [const] SubAssign + [const] Clone + [const] Destruct> SubAssign<T> for Matrix4x4<T> {
...
const impl Sub<Matrix4x4<u8>> for u8 {
...
const impl Sub<Matrix4x4<u16>> for u16 {
...
const impl Sub<Matrix4x4<u32>> for u32 {
...
const impl Sub<Matrix4x4<u64>> for u64 {
...
const impl Sub<Matrix4x4<u128>> for u128 {
...
const impl Sub<Matrix4x4<usize>> for usize {
...
const impl Sub<Matrix4x4<i8>> for i8 {
...
const impl Sub<Matrix4x4<i16>> for i16 {
...
const impl Sub<Matrix4x4<i32>> for i32 {
...
const impl Sub<Matrix4x4<i64>> for i64 {
...
const impl Sub<Matrix4x4<i128>> for i128 {
...
const impl Sub<Matrix4x4<isize>> for isize {
...
const impl Sub<Matrix4x4<f32>> for f32 {
...
const impl Sub<Matrix4x4<f64>> for f64 {
