use crate::math::{Quaternion, number::ApproxEq};
use std::marker::Destruct;

impl<T> Quaternion<T> {
    /// Is this quaternion approximately equal to `other`?
    pub const fn approx_eq(self, other: Quaternion<T>, epsilon: T::Epsilon) -> bool
    where
