...
const impl<T: [const] Div<Output = T> + [const] Destruct> Div for Vector2<T> {
    type Output = Self;
...
const impl<T: [const] Div<Output = T> + [const] Clone + [const] Destruct> Div<T> for Vector2<T> {
    type Output = Self;
...
const impl<T: [const] DivAssign + [const] Destruct> DivAssign for Vector2<T> {
...
const impl<T: [const] DivAssign + [const] Clone + [const] Destruct> DivAssign<T> for Vector2<T> {
...
const impl Div<Vector2<u8>> for u8 {
...
const impl Div<Vector2<u16>> for u16 {
...
const impl Div<Vector2<u32>> for u32 {
...
const impl Div<Vector2<u64>> for u64 {
...
const impl Div<Vector2<u128>> for u128 {
...
const impl Div<Vector2<usize>> for usize {
...
const impl Div<Vector2<i8>> for i8 {
...
const impl Div<Vector2<i16>> for i16 {
...
const impl Div<Vector2<i32>> for i32 {
...
const impl Div<Vector2<i64>> for i64 {
...
const impl Div<Vector2<i128>> for i128 {
...
const impl Div<Vector2<isize>> for isize {
...
const impl Div<Vector2<f32>> for f32 {
...
const impl Div<Vector2<f64>> for f64 {
