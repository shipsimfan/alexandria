...
const impl<T: [const] Mul<Output = T> + [const] Destruct> Mul for Vector2<T> {
    type Output = Self;
...
const impl<T: [const] Mul<Output = T> + [const] Clone + [const] Destruct> Mul<T> for Vector2<T> {
    type Output = Self;
...
const impl<T: [const] MulAssign + [const] Destruct> MulAssign for Vector2<T> {
...
const impl<T: [const] MulAssign + [const] Clone + [const] Destruct> MulAssign<T> for Vector2<T> {
...
const impl Mul<Vector2<u8>> for u8 {
...
const impl Mul<Vector2<u16>> for u16 {
...
const impl Mul<Vector2<u32>> for u32 {
...
const impl Mul<Vector2<u64>> for u64 {
...
const impl Mul<Vector2<u128>> for u128 {
...
const impl Mul<Vector2<usize>> for usize {
...
const impl Mul<Vector2<i8>> for i8 {
...
const impl Mul<Vector2<i16>> for i16 {
...
const impl Mul<Vector2<i32>> for i32 {
...
const impl Mul<Vector2<i64>> for i64 {
...
const impl Mul<Vector2<i128>> for i128 {
...
const impl Mul<Vector2<isize>> for isize {
...
const impl Mul<Vector2<f32>> for f32 {
...
const impl Mul<Vector2<f64>> for f64 {
