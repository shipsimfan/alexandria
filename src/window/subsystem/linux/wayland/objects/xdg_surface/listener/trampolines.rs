use crate::window::{XdgSurface, XdgSurfaceListener, XdgSurfaceRef, XdgWmBase};
...
impl<T: XdgSurfaceListener> XdgSurface<T> {
    ...
    pub(in crate::window::subsystem::linux::wayland::objects::xdg_surface::listener) const LISTENER:
